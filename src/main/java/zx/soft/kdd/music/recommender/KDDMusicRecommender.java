package zx.soft.kdd.music.recommender;
...
import zx.soft.kdd.music.recommender.core.ParallelKNN;
import zx.soft.kdd.music.recommender.core.Recommender;
import zx.soft.kdd.music.recommender.core.SequentialKNN;
...
public class KDDMusicRecommender {
	...
	private static void preprocess() {
		...
		Preprocessing pp = new Preprocessing(list.get(0), list.get(1), Integer.parseInt(list.get(2)),
