...
public class ParallelKNN extends Configured implements Recommender {
	 ...
	 */
	public static class CalcMap extends Mapper<Object, Text, IntWritable, Text> {

		private final Users myUsers = new Users();
		private final Songs mySongs = new Songs();
	...
	public static class CalcReduce extends Reducer<IntWritable, Text, IntWritable, Text> {

		@Override
		public void reduce(IntWritable songId, Iterable<Text> sim, Context context) throws IOException,
